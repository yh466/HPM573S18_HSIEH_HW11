...
def print_outcomes(simOutput, therapy_name):
    ...
    # mean and confidence interval text of number of stroke
...
def draw_survival_curves_and_histograms(simOutputs_none, simOutputs_anticoag):
    ...
    :param simOutputs_none: output of a cohort simulated under no anticoagulant
    :param simOutputs_anticoag: output of a cohort simulated under anticoagulant
    """
    ...
    PathCls.graph_sample_paths(
        ...
        legends=['No Anticoagulant', 'Anticoagulant']
    )
    ...
    Figs.graph_histograms(
        ...
        y_label='Counts',
        bin_width=1,
        legend=['No Anticoagulant', 'Anticoagulant'],
        transparency=0.6
    )
...
def print_comparative_outcomes(simOutputs_none, simOutputs_anticoag):
    ...
    # increase in survival time under anticoagulant with respect to no therapy
    ...
    # increase in discounted total cost under anticoagulant with respect to no therapy
    ...
    # increase in discounted total utility under anticoagulant with respect to no therapy
